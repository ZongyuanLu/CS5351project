        ...
        <el-dropdown class="user-container" @command="userCommand">
            ...
            <template #dropdown>
                <el-dropdown-menu class="user-dropdown">
                    <el-dropdown-item v-if="$store.state.settings.enableDashboard" command="dashboard">console</el-dropdown-item>
                    <el-dropdown-item command="setting">profile</el-dropdown-item>
