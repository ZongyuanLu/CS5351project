...
public class ScrumServiceITCase {
    ...
    @Test
    public void testDurationAndAuthor() {
        //given
        Integer duration = 14;
        ScrumDTO scrumDTO = ScrumDTO.builder()
                .title("Test Scrum").author("test Author").duration(duration)
                .build();
        ...
        assertEquals("test Author", scrums.get(0).getAuthor());
        assertEquals(duration, scrums.get(0).getDuration());
    }
    ...
    public void whenNewScrumCreated_thenScrumIsSavedInDb() {
        ...
        assertNotNull(scrums.get(0));
        assertEquals("oScrum", scrums.get(0).getTitle());
    }
}
*/